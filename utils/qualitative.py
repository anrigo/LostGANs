...
def sample_one(idx: int = None, show_bbox: bool = False, show_labels: bool = False, show_idx: bool = False):
    '''
    ...
    Args:
        ...
        show_bbox: if True visualize the bounding boxes on the real image
        show_labels: if True the labels will be visualized on the layout
        show_idx: if True the objects' indices will be visualized
    '''
    ...
    layout = draw_bboxes(layout, bbox, labels, show_idx=show_idx, text=show_labels)

    axs[ax_id].imshow(layout.permute(1, 2, 0))
    axs[ax_id].set_title('Layout')
    ax_id += 1
    ...
    axs[ax_id].set_title('Real image')
